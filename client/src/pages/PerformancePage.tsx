...
export default function PerformancePage() {
    ...
    // Reset pagination when filtered attempts change
    useEffect(() => {
        setCurrentPage(1);
    }, [selectedDate, attemptsData]);
    ...
    const fetchAttempts = async (positionId: string) => {
        try {
            ...
            setAttemptsData(res.data || []);
            // Reset to today's date when fetching new attempts
                    ...
                    <DialogHeader className="flex flex-col md:flex-row justify-between items-center m-3">
                        ...
                        <div className="relative">
                            ...
                            {calendarOpen && (
                                <div
                                    ref={calendarRef}
                                    className="absolute top-full right-0 mt-2 bg-white border border-gray-300 rounded-lg shadow-lg z-50 p-3"
                                ...
                                >
                                    <Calendar
                                        ...
                                        onChange={(value: Dayjs) => {
                                            ...
                                            // Optionally, you can auto-close after a short delay
